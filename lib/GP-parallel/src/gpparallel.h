...
#ifndef GPParallel_hh
#define GPParallel_hh
...
public:
   ...
   GPParallel( ParamsParallel& p, cl_device_type );
   virtual ~GPParallel()
   { 
      delete[] m_X;
      delete[] m_E;
...
protected:
   ...
   PrimitivesParallel m_primitives;
protected:
...
public:
   ...
   static ParamsParallel* m_params; /**< Pointer to Params class (holds the parameters). */
};
