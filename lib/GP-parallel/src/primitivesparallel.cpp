...
// -----------------------------------------------------------------------------
PrimitivesParallel::PrimitivesParallel(): m_need_identity( false ),
...
// -----------------------------------------------------------------------------
std::pair<cl_uint, cl_uint> PrimitivesParallel::Find( const std::string& token )
{
...
// -----------------------------------------------------------------------------
void PrimitivesParallel::Register( cl_uint arity, const std::string& name, const std::string& symbol,
...
// -----------------------------------------------------------------------------
void PrimitivesParallel::Load( unsigned x_dim, unsigned max_gen_size, const std::string& primitives )
{
...
// -----------------------------------------------------------------------------
cl_uint PrimitivesParallel::RandomNode( unsigned min, unsigned max ) const
{
