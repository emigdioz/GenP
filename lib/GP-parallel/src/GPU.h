...
// -----------------------------------------------------------------------------
class GPonGPU: public GPParallel {
public:
   GPonGPU( ParamsParallel& p ): GPParallel( p, CL_DEVICE_TYPE_GPU )
   {
...
public:
   PPCU( ParamsParallel& p ): GPonGPU( p )
   {
...
public:
   PPPE( ParamsParallel& p ): GPonGPU( p )
   {
...
public:
   FPI( ParamsParallel& p ): GPonGPU( p )
   {
...
public:
   FPC( ParamsParallel& p ): GPonGPU( p )
   {
